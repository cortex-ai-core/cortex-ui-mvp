...
export default function DocumentsPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // All other roles see all documents (super_admin, admin, operator, viewer)
  ...
  // ============================================================
  // DELETE HANDLER (Unaffected by 44C)
  // ============================================================
